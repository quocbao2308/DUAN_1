                            ...
                            <div class="h-100">
                                <div class="card">
                                    <div class="card-header align-items-center d-flex">
                                        ...
                                        <a href="?act=them-trang-thai" class="btn btn-soft-success material-shadow-none"><i class="ri-add-circle-line align-middle me-1"></i> Thêm trạng thái</a>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="hstack gap-3 flex-wrap">
                                                                        <a href="?act=sua-trang-thai&id=<?= $trangThai['id'] ?>" class="link-success fs-15"><i class="ri-edit-2-line"></i></a>
                                                                        <form action="?act=xoa-trang-thai&id=<?= $trangThai['id'] ?>" method="POST"
